    ...
    private static void solve() {
        ...
        loop:while (numCases-->0) {
            // Insert code here.
               ...
               for (int i = 1; i <= n; i++) {
                    int negs = n-i;
                    int posOnePairs = (i*(i-1))/2;
                    int negOnePairs = ((negs)*(negs-1))/2;
                    if (posOnePairs+negOnePairs==k) {
                        System.out.println("YES");
                        for (int j = 0; j < i; j++) System.out.print(1+" ");
                        for (int j = i; j < n; j++) System.out.print(-1+" ");
                        System.out.println();
                        continue loop;
                    }
               }
