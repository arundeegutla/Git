...
public class maze {
    ...
    private static void solve() {
        ...
        while (numCases-->0) {
            ...
            n = in.nextInt();
            m = in.nextInt();
            System.out.println(Math.min(getBlock(in.nextInt(), in.nextInt()), getBlock(in.nextInt(), in.nextInt())));
        }
    ...
    * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
    ...
    private static int getBlock(int x, int y) {
        int blocks = 4;

        if (x==1 && y == 1 || x == n && y == m || x == n && y == 1 || y == m && x == 1) {
            return blocks - 2;
        }
        if (TIME) {
